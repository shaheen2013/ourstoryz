...
function create_signup_post_type() {
  $labels = array(
      'name'                  => _x( 'Signups', 'Post Type General Name', 'text_domain' ),
      'singular_name'         => _x( 'Signup', 'Post Type Singular Name', 'text_domain' ),
      'menu_name'             => __( 'Signups', 'text_domain' ),
      'name_admin_bar'        => __( 'Signup', 'text_domain' ),
      'archives'              => __( 'Signup Archives', 'text_domain' ),
      'attributes'            => __( 'Signup Attributes', 'text_domain' ),
      'parent_item_colon'     => __( 'Parent Signup:', 'text_domain' ),
      'all_items'             => __( 'All Signups', 'text_domain' ),
      'add_new_item'          => __( 'Add New Signup', 'text_domain' ),
      'add_new'               => __( 'Add New', 'text_domain' ),
      'new_item'              => __( 'New Signup', 'text_domain' ),
      'edit_item'             => __( 'Edit Signup', 'text_domain' ),
      'update_item'           => __( 'Update Signup', 'text_domain' ),
      'view_item'             => __( 'View Signup', 'text_domain' ),
      'view_items'            => __( 'View Signups', 'text_domain' ),
      'search_items'          => __( 'Search Signup', 'text_domain' ),
      ...
      'insert_into_item'      => __( 'Insert into Signup', 'text_domain' ),
      'uploaded_to_this_item' => __( 'Uploaded to this Signup', 'text_domain' ),
      'items_list'            => __( 'Signups list', 'text_domain' ),
      'items_list_navigation' => __( 'Signups list navigation', 'text_domain' ),
      'filter_items_list'     => __( 'Filter Signups list', 'text_domain' ),
  );
  $args = array(
      'label'                 => __( 'Signup', 'text_domain' ),
      'description'           => __( 'Signup Description', 'text_domain' ),
      'labels'                => $labels,
...
add_action( 'init', 'create_signup_post_type', 0 );
