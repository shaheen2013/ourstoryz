...
{
    return plugin_dir_url(__FILE__)  . '/assets/images' . $path;
}
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" id="signin-modal">
                            ...
                            <div class="geospaced-event w-360 d-flex flex-column">
                                ...
                                <div class="p-3">
                                    <div class="fs-14 text-center mb-10">
                                        If you just want to explore with a simple, one-time event free event, choose the
                                        Locator option. You can upgrade later if desired.
                                    </div>
                    ...
                    <div id="give-your-event-name-section" class="w-600 d-none">
                        ...
                        <div class="fs-14 mt-20 divider mb-20 pb-20">Let us know a little more about yourself so we can
                            begin creating your basic Locator account.
                        </div>
                        ...
                        <div class="mt-20 fs-16 divider pb-20 mb-20">Your default role is ‘event organizer’ - you can add
                            additional roles after completing the signup process.
                        </div>
                    ...
                    <div id="add-location-section" class="w-600 d-none">
                        ...
                        <div onclick="handleSetModal('why-list-location')" class="text-center text-decoration-underline fs-14 fw-semibold mt-2" type="button">Why do I
                            need to list a
                            location?
                        </div>
                    ...
                    <div id="add-dates-section" class="w-600 d-none">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div onclick="handleSetModal('about-yourself-section')" class="btn btn-dark rounded-pill w-100 ">Continue
                            </div>
                        ...
                        <div onclick="handleSetModal('why-list-dates')" class="text-center text-decoration-underline fs-14 fw-semibold mt-2" type="button">Why do I
                            need to list a date?
                        </div>
                    ...
                    <div id="about-yourself-section" class="w-600 d-none">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div id="about-continue-btn" onclick="handleSetModal('add-image-event-section')" class="disabled btn btn-dark rounded-pill w-100 ">Continue
                            </div>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div id="add-image-event-section" class="w-390 d-none">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="h-100 d-flex flex-column justify-content-center p-4 ps-0">
                                                <div class="mt-20 fs-16 mb-10 fw-semibold text-center text-dark">Event
                                                    image
                                                </div>
                                                <div class="fs-12 text-center mb-10">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div data-bs-dismiss="modal" class="btn btn-dark rounded-pill w-100 ">Continue
                            </div>
                    ...
                    <div id="choose-level-service-section" class="d-none">
                        ...
                        <div class="mt-20 d-flex flex-column flex-sm-row gap-2">
                            <div class="geospaced-event w-360 d-flex flex-column border rounded-4 border-blue">
                                ...
                                <div onclick="handleSetModal('add-dates-section')" class="btn btn-dark w-100 mt-auto">Select DIY for $99/1 year
                                </div>
                            </div>
                            <div class="geospaced-event w-360 d-flex flex-column border rounded-4 border-blue">
                                ...
                                <div class="btn btn-dark bg-transparent text-black w-100 mt-auto">Select Professional for
                                    $40/month
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="events-larger-wedding-section" class="w-600 d-none">
                        ...
                        <div onclick="handleSetModal('add-location-section')" class="btn btn-dark rounded-pill w-100 mt-auto">Continue
                        </div>
...
">
                    ...
                    <div id="tell-organization-section" class="w-600 d-none">
                        ...
                        <div class="row">
                            <div class="col-sm-5 mb-3 mb-sm-0">
                                <div class="h-100 border border-blue rounded-4 p-4">
                                    ...
                                    <div class="fs-12 text-center mb-10">
                                        Upload your logo, if you have one. This image will appear on your vendor page. Nee a
                            ...
                            <div class="col-sm-7">
                                <div class="h-100 d-flex flex-column">
                                    <div>
                                        ...
                                        <input type="text" id="org-name" class="form-control mt-2" placeholder="enter a name for company or organizaton">
                                    </div>
                                    <div class="mt-20">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div id="org-continue-btn" onclick="handleSetModal('add-image-event-section')" class="disabled btn btn-dark rounded-pill w-100 ">Continue
                            </div>
                        </div>
                    ...
                    <div id="invite-team-member-section" class="w-600 d-none">
                        ...
                        <div class="fs-16 divider mb-20 pb-20">Invite additional team members. You can invite anyone from
                    ...
                    <div id="sorry-to-see-section" class="w-600 d-none">
                        ...
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <div class="fs-16 mt-3">
                                    Let us know if you want to receive our free newletter. Our newsletter details upcoming
                        ...
                        <div class="d-flex justify-content-between gap-4">
                            <div onclick="handleSetModal('newsletter-set-section')" class="btn btn-dark rounded-pill w-100 ">I like free, send newsletter
                            </div>
                            <div data-bs-dismiss="modal" class="btn px-5 btn-dark rounded-pill border-dark border fw-semibold bg-transparent text-dark">
                                Nope
                            </div>
